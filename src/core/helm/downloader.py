...
logger = setup_logging("helm_processor.log", "HELM_Core_Downloader")
...
def _try_get_json_data(task: str, file_type: str, version: str, benchmark: str) -> dict | None:
...
def download_task(task: str, output_dir: str, benchmark: str, overwrite: bool = False,
                  start_version: str = DEFAULT_START_VERSION) -> str | None:
    """
